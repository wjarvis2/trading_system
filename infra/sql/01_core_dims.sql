...
CREATE TABLE core_energy.fact_series_value_1980_1985
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('1980-01-01') TO ('1985-01-01');

CREATE TABLE core_energy.fact_series_value_1985_1990
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('1985-01-01') TO ('1990-01-01');

CREATE TABLE core_energy.fact_series_value_1990_1995
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('1990-01-01') TO ('1995-01-01');

CREATE TABLE core_energy.fact_series_value_1995_2000
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('1995-01-01') TO ('2000-01-01');

CREATE TABLE core_energy.fact_series_value_2000_2005
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('2000-01-01') TO ('2005-01-01');

CREATE TABLE core_energy.fact_series_value_2005_2010
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('2005-01-01') TO ('2010-01-01');

CREATE TABLE core_energy.fact_series_value_2010_2015
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('2010-01-01') TO ('2015-01-01');

CREATE TABLE core_energy.fact_series_value_2015_2020
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('2015-01-01') TO ('2020-01-01');

CREATE TABLE core_energy.fact_series_value_2020_2025
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('2020-01-01') TO ('2025-01-01');

CREATE TABLE core_energy.fact_series_value_2025_2030
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('2025-01-01') TO ('2030-01-01');

CREATE TABLE core_energy.fact_series_value_2030_2035
  PARTITION OF core_energy.fact_series_value
  FOR VALUES FROM ('2030-01-01') TO ('2035-01-01');

CREATE TABLE core_energy.fact_series_value_2035_2040
  PARTITION OF core_energy.fact_series_value
